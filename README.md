...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-union-1cd6
```

A live public deployment of this template is available at [https://frosty-union-1cd6.templates.workers.dev](https://frosty-union-1cd6.templates.workers.dev)
